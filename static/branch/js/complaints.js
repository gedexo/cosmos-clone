         ...
         success: function (response) {
             ...
             function drawRow(rowData) {
                ...
                table = $("#complaintsTable").DataTable();            
                 ...
                 tableData.push([rowData["complaint"],rowData['category'],edit,deleteRequest])
...
$("#complaintsForm").validate({
    ...
    submitHandler: function (e) {
        ...
        if (editId != 0) {
            $.ajax({
                url: "/branchapi/api/complaints/" + editId + "/",
                type: "PUT",
                data: data,
                beforeSend: function (xhr) {
                    xhr.setRequestHeader(
            ...
            $.ajax({
                ...
                statusCode: {
                    201: function (response) {
                        ...
                        tableData.push([response["complaint"],response['category'],edit,deleteRequest])
                        table.rows.add(tableData).draw();
                        },
                        500: function(){
...
$(document).on('click', '#btnEdit', function () {
    ...
    var id = $(this).val();
    $('textarea[name=complaint]').val(name);
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "/branchapi/api/complaints/" + id + "/",
                    type: "DELETE",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader(
                            "Authorization",

     ...
     $.ajax({
         ...
         success: function (response) {
             ...
             function drawRow(rowData) {
                var tableData = [];
                table = $("#modelNameTable").DataTable();            
                 ...
                 tableData.push([rowData["name"],edit,deleteRequest])
...
$("#modelNameForm").validate({
    ...
    submitHandler: function (e) {
        ...
        if (editId != 0) {
            $.ajax({
                url: "/branchapi/api/model-name/" + editId + "/",
                type: "PUT",
                data: data,
                beforeSend: function (xhr) {
                    xhr.setRequestHeader(
            ...
            $.ajax({
                ...
                statusCode: {
                    201: function (response) {
                        ...
                        tableData.push([response["name"],edit,deleteRequest])
                        table.rows.add(tableData).draw();
                        },
                        500: function(){
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    url: "/branchapi/api/model-name/" + id + "/",
                    type: "DELETE",
                    beforeSend: function (xhr) {
                        xhr.setRequestHeader(
                            "Authorization",
